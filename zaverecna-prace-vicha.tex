...
\newcommand\nazevPrace{Webová aplikace na zobrazení 3D modelů pomocí Aframe} %% vyplň název své práce
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	{\fontfamily{phv}\selectfont
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.8\linewidth]{image/fotka.png} 
		\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\noindent Tato studie se zaměřuje na vytvoření webové stránky, která umožní
	snadné zobrazení a stahování 3D modelů. Základní deskou tohoto projektu je
	databáze MySQL, což zajišťuje efektivní ukládání a správu dat. Pro
	implementaci webové stránky byl vybrán programovací jazyk Django, který je
	známý svou uživatelskou přívětivostí a zároveň nabízí různé vestavěné
	šablony.Programovací jazyk Django je ideální volbou pro tvorbu webových
	aplikací, protože poskytuje robustní a komplexní rámeček pro vývoj, zároveň
	však udržuje jednoduchost a snadné používání. Jeho vestavěné šablony
	usnadňují vývojářům práci tím, že poskytují hotové struktury a prvky, které
	lze snadno přizpůsobit potřebám projektu.Databáze MySQL slouží jako úložiště
	pro 3D modely a další související informace. Díky kombinaci těchto
	technologií je cílem vytvořit webovou stránku, která bude nejen vizuálně
	atraktivní, ale také jednoduše ovladatelná pro uživatele, kteří chtějí
...
%Třetí parametr Úvod je text, který se objeví v obsahu. V tomto případě bude v obsahu zobrazen název "Úvod".	
	Vytvoření webové stránky, která se specializuje na zobrazení 3D modelů, představuje nejen technologický pokrok, ale přináší také řadu výhod a příležitostí pro různá odvětví. Tato inovativní platforma není pouze
prostředkem prezentace, ale otevírá dveře k interaktivitě, tvůrčímu projevu a vzdělávacím zážitkům. V první řadě, schopnost vizuální prezentace na vysoké úrovni je klíčovým prvkem. 3D modely umožňují uživatelům prozkoumávat prezentované objekty nejen z jednoho pohledu, ale otáčet, zoomovat a přibližovat si je, což vytváří dojem reálné interakce a poskytuje komplexní představu o designu a struktuře. Interaktivní prvek vytváří prostředí, které zajímá a udržuje pozornost. Možnost ovládat vizualizace podněcuje zvědavost a zájem návštěvníků, kteří si mohou prohlížet 3D modely podle svých individuálních preferencí a potřeb. Pro umělce a designéry tato platforma slouží jako virtuální galerie. 3D modely umožňují podrobné a nápadité prezentace jejich prací, což zvyšuje jejich dosah a poskytuje prostor pro kreativní projev. Vzdělávání přesahující tradiční metody je dalším pozitivním aspektem. Webová stránka s 3D modely může sloužit jako interaktivní učební materiál, kde studenti, profesionálové i zájemci mají příležitost prohlédnout si objekty z blízka a získat lepší porozumění složitým konceptům a designům.

Cílem bylo sestavení webové stránky se zobrazením a stáhnutím 3D modelů co nejpřehledněji. Aplikace by měla obsahovat registraci a přihlášení uživatelů  pro nahrání 3D modelů i s možností hodnocení modelů a zobrazení jiných uživatelů. Uživatel by měl mít možnost upravit si vlastní profil o různé informace a taky přidat nebo upravit různé informace o vlastních modelech. Všechny model jsou přehledně na jedné stránce kde je možnost filtrace modelů. Celá webová stránka by měla být responzivní, aby fungovala na jiných zařízeních.

V rámci projektové dokumentace se zaměřuji na postup tvorby konkrétní stránky. Začínám analýzou databázového modelu v úvodní části. Následně se věnuji správě uživatelských účtů, implementaci formulářů pro přidání a editaci dat a vytváření pohledů pro prezentaci modelů a uživatelů. V závěrečné části se pak soustředím na design samostatné vizuální stránky a její přizpůsobení pro různá zařízení.
...
Webové stránky pro zobrazení 3D modelů poskytují prostor pro interaktivní prezentaci třírozměrných objektů přes internet. Tyto stránky mohou být využívány v různých odvětvích, včetně designu, vzdělávání, průmyslu, umění a mnoha dalších. Webové stránky ve kterých je možné si zobrazit 3D modely je několik, ale většina z nich je placená a složitá. To jsou jedny z mála faktorů proč 

\section{Architektura databázových aplikací}
\label{sec:architektura}
Model-View-Controller (MVC) je architektonický vzor často používaný při vývoji databázových aplikací. Tato architektura rozděluje aplikaci do tří hlavních komponent - Model, View a Controller. Každá z těchto komponent má svou specifickou roli, a v kombinaci spolu tvoří robustní a dobře organizovaný rámec pro vývoj sofistikovaných databázových aplikací. 
\begin{figure}[h]
			\centering
			\includegraphics[width=0.5\linewidth]{image/MVC.png} 
			\caption{Logika MVC}
			\label{fig:mvc}
\end{figure}

Celý cyklus práce s architekturou MVC může být rozdělen do několika kroků. Architektura MVC poskytuje oddělení mezi logikou aplikace, manipulací s daty a prezentací. To umožňuje snadnou údržbu, rozšíření a znovupoužití kódu. Každá část architektury má svůj specifický účel a přispívá k celkové funkčnosti aplikace. Tímto způsobem MVC poskytuje systematický a efektivní přístup k vývoji komplexních databázových aplikací.
\section{Počáteční zkušenosti}
Během třetího ročníku jsem se intenzivně věnoval tvorbě databázových aplikací v rámci frameworku Django a na manipulaci obsahu databáze MySQL. Zaměřil jsem se na efektivní využití generických funkcí a implementaci uživatelského systému v souladu s nativními možnostmi, které Django poskytuje. Cílem bylo vytvořit funkční aplikaci s minimálním úpravami standardních prvků frameworku.Pro správu databáze jsem preferoval nástroj phpMyAdmin, který mi umožňoval snadné provádění operací nad databází přes webové rozhraní. Tyto dovednosti vytvořily pevný základ pro mé další projekty v oblasti databázového vývoje.
	...
	\section[Bootstrap 4.4.1]{Bootstrap 4.4.1} 
...
A-Frame je vhodný pro tvorbu různých typů projektů, včetně virtuálních prohlídek, interaktivních edukativních aplikací, her a dalších 3D prostorových zážitků na webu.
	...
	\section[Databázový model]{Databázový model}
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.9\linewidth]{image/model.png} 
			\caption{ER diagram}
		\end{figure}
		\clearpage
...
Uživatelský systém, který řídí přihlašování a registraci uživatelů, je klíčovým prvkem každé aplikace, a je nezbytné zajistit, aby uživatelé měli přístup pouze k těm akcím, které neporušují integritu a chod aplikace. Pro řešení této problematiky jsem se rozhodl využít vestavěný model uživatele v rámci frameworku Django, konkrétně balíčku django-contrib-auth-models. Tento balíček poskytuje robustní implementaci uživatelského modelu nazvaného User, který slouží k reprezentaci uživatelů v systému.
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.9\linewidth]{image/login.png} 
			\caption{Formulář na přihlášení}
		\end{figure}
...
Jedním z klíčových prvků je také řízení přístupových práv uživatelů. Django-contrib-auth-models nabízí robustní systém oprávnění, který umožňuje definovat, které části aplikace může uživatel přistupovat a jaké akce může provádět. To zajišťuje, že uživatelé mají pouze oprávnění, která jsou nezbytná pro správný chod aplikace, a minimalizuje riziko možných neoprávněných činností.
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.8\linewidth]{image/register.png} 
			\caption{Formulář na registraci}
		\end{figure}
...
\begin{figure}[h]
			\centering
			\includegraphics[width=0.5\linewidth]{image/edit-profil.png} 
			\caption{Formulář úpravu profilu}
		\end{figure}
		
Tento komplexní formulář slouží k efektivnímu shromažďování klíčových informací o uživateli, přičemž zahrnuje jeho osobní údaje, jako jsou jméno, příjmení, e-mailová adresa, preferovaná rodná zaměření, profilový obrázek a stručná biografie. Tímto způsobem získáváme komplexní a relevantní informace, které nám umožňují lepší porozumění uživatelům a poskytování cílenějších služeb na naší platformě.

Formulář není pouze prostředkem pro shromažďování informací, ale také představuje nástroj pro zlepšení uživatelské interakce a začlenění jednotlivců na naší platformě. Tyto informace nám umožňují lépe pochopit potřeby uživatelů a poskytnout jim personalizované zážitky, což přispívá k celkové spokojenosti a efektivitě jejich interakce s naší službou.

Kromě toho formulář obsahuje praktickou možnost změny hesla, což přispívá k bezpečnosti účtu uživatele. Odkaz na další formulář o změně hesla umožňuje uživatelům snadno a bezpečně aktualizovat svá přihlašovací údaje podle svých potřeb a preferencí.
...
\begin{figure}[h]
			\centering
			\includegraphics[width=0.8\linewidth]{image/change-password.png} 
	...
	Databáze následně prezentuje tyto modely ostatním uživatelům, kteří mohou prohlížet, hodnotit a stahovat modely dle svých potřeb. Uživatelská interakce s modelem je klíčová, protože umožňuje tvůrcům získat zpětnou vazbu od komunity a vylepšit své modely na základě reálných potřeb uživatelů.
	\begin{figure}[h]
			\centering
			\includegraphics[width=1\linewidth]{image/model-nahrani.png} 
			\caption{Formulář pro nahrání modelu}
		\end{figure}
	Pro uživatele, kteří nahráli model, je k dispozici přehled vlastních modelů, což umožňuje snadný přístup k informacím, aktualizacím a případným budoucím úpravám. Celkově tato platforma vytváří interaktivní a společenský prostor pro sdílení a využívání 3D modelů s ohledem na uživatelské potřeby a preference.
...
\begin{figure}[h]
			...
			\caption{Funkce které řesí filtraci ve views.py}
		\end{figure}
...
Tato interaktivní možnost úpravy umožňuje uživateli vylepšit a personalizovat svůj model, aby co nejlépe odpovídal jeho individuálním potřebám a preferencím. Tímto způsobem má uživatel plnou kontrolu nad tím, jakým směrem se vyvíjí jeho vlastní model, a může ho dále zdokonalovat podle svých aktuálních požadavků.
\subsection[Zobrazení]{Zobrazení}
Preview modelu je elegantním způsobem prezentace, který využívá karty k zobrazení klíčových informací o každém modelu. Každá karta obsahuje vizuální obrázek, název a průměrné hodnocení daného modelu, což umožňuje uživatelům rychle získat přehled o dostupných modelech. Při najetí myší na konkrétní kartu se automaticky zobrazí podrobnější informace, což zahrnuje údaje jako jméno uživatele, který model nahrál, popis samotného modelu a datum, kdy byl model nahrán do systému.
\begin{figure}[h]
			\centering
			\includegraphics[width=1\linewidth]{image/model-view.png} 
			\caption{Zobrazení modelů}
		\end{figure}
		
Tato interaktivní funkcionalita nabízí uživatelům příležitost získat hlubší vhled do každého modelu, a to vše na jediném uživatelsky příjemném rozhraní. Kromě toho je implementována funkce, která umožňuje hodnocení modelu na 1-5 hvězdičkami, pokud uživatel, který hodnotí, není tím samým tvůrcem modelu. Tato bezpečnostní opatření zajistí, že hodnocení jsou poskytována pouze uživateli, kteří nemají konflikt zájmů a mohou poskytnout objektivní zpětnou vazbu.
\section[Zobrazení modelu]{Zobrazení modelu}
	\chapter{Závěr}
